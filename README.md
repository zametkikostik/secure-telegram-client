...
│                           │                           │
├── ✅ Базовая архитектура   ├── ✅ Web3 интеграции      ├── 🎯 iOS приложение
│   (январь-март)           │   (апрель-июнь)           │   (июль-сентябрь)
│                           │                           │
├── ✅ P2P сеть             ├── ✅ AI функции           ├── 🎯 Мультиязычность
│   (январь-март)           │   (апрель-июнь)           │   (июль-сентябрь)
│                           │                           │
├── ✅ Android APK          ├── ✅ Smart contracts      ├── 🎯 Desktop v2.0
│   (январь-март)           │   (апрель-июнь)           │   (октябрь-декабрь)
│                           │                           │
├── ✅ Web frontend         ├── ✅ Миграция из TG/WA    ├── 🎯 AR/VR интеграция
│   (январь-март)           │   (апрель-июнь)           │   (октябрь-декабрь)
│                           │                           │
...
- [ ] **Децентрализованное хранение** — IPFS для файлов
