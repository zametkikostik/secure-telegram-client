...
|------------|----------|--------|
| obfs4 | Обфускация трафика | 🟡 В разработке |
| Shadowsocks | Прокси с шифрованием | 🟡 В разработке |
| TLS Fingerprint | Подмена JA3 отпечатка | ⏳ Запланировано |
| DNS over HTTPS | Обход DNS блокировок | ⏳ Запланировано |

### 🌐 Децентрализация
| Компонент | Назначение | Статус |
|-----------|------------|--------|
| IPFS | Хостинг релизов | 🟡 В разработке |
| libp2p DHT | Поиск пиров | 🟡 В разработке |
| Gossipsub | P2P месседжинг | 🟡 В разработке |
...
| Sync State | Синхронизация | 🟡 В разработке |
