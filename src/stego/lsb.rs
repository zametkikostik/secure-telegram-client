...
impl LsbSteganography {
    ...
    pub fn embed(&self, image: &DynamicImage, data: &[u8]) -> Result<DynamicImage> {
        ...
        log::debug!("Данные встроены (использовано {} из {} байт)", data.len(), capacity);
